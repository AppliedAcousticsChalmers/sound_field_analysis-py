...
def test_ideal_wave_open_omni():
    array_configuration = io.ArrayConfiguration(
        array_radius=0.5, array_type="open", transducer_type="omni"
    )
    results_open_omni = np.array(
        [
            [3.5449077018, -0.0642580673, 0.0065998911, 0.0205155302, -0.0064606444],
            [
                0,
                -0.0047384232 + 0.0030425066j,
                -0.0274719035 + 0.0176395064j,
                0.0055649133 - 0.0035731897j,
...
def test_ideal_wave_open_cardioid():
    array_configuration = io.ArrayConfiguration(
        array_radius=0.5, array_type="open", transducer_type="cardioid"
    )
    results_open_cardioid = np.array(
        [
            [
                1.7724538509,
                -0.0321290337 + 0.0027319952j,
                0.0032999455 + 0.0158392581j,
                0.0102577651 - 0.0032085181j,
                -0.0032303222 - 0.0074153959j,
            ],
            [
                0.3289843794 + 0.5123628138j,
                -0.0203150233 - 0.0264276926j,
                -0.0120591719 + 0.011431183j,
                0.0085159795 + 0.0071428379j,
                0.0046695870 - 0.0068718764j,
            ],
            [
                0.5529057800,
                -0.0301605294 + 0.0025566859j,
                0.0028180708 + 0.0148228695j,
                0.0096360135 - 0.0030026308j,
                -0.0029598052 - 0.0069395577j,
            ],
            [
                0.3289843794 - 0.5123628138j,
                -0.0155766001 + 0.0294701991j,
                0.0154127316 + 0.0062083233j,
                0.0029510662 - 0.0107160276j,
...
def test_ideal_wave_rigid_omni():
    array_configuration = io.ArrayConfiguration(
        array_radius=0.5, array_type="rigid", transducer_type="omni", scatter_radius=0.5
    )
    results_rigid_omni = np.array(
        [
            [
                -0.0643576059 + 0.0054621765j,
                -0.0643576059 + 0.0054621765j,
                0.0063112724 + 0.0316758864j,
                0.0205545085 - 0.0064167993j,
                -0.0063930795 - 0.0148304841j,
            ],
            [
                -0.0396107140 - 0.0535098563j,
                -0.0396107140 - 0.0535098563j,
                -0.0241659405 + 0.0228929274j,
                0.0169234688 + 0.0143553364j,
                0.0093641662 - 0.0137598001j,
            ],
            [
                -0.0603210321 + 0.0040133970j,
                -0.0603210321 + 0.0040133970j,
                0.0056361414 + 0.0296971018j,
                0.0192720269 - 0.0058881867j,
                -0.0059196103 - 0.0139060852j,
            ],
            [
                -0.0321725013 + 0.0582858777j,
                -0.0321725013 + 0.0582858777j,
                0.0308730596 + 0.0124472082j,
                0.0060106225 - 0.0213623945j,
...
def test_sampled_wave_open_omni():
    array_configuration = io.ArrayConfiguration(
        array_radius=0.1, array_type="open", transducer_type="omni"
    )
    results_open_omni = np.array(
        [
            [
            ...
            [
                0,
                -8.8558806782570e-01j,
                1.4008429690376e00j,
                -1.3302966027074e00j,
                7.0344988487660e-01j,
            ],
            [
                0,
                -4.2327000000000e-09j,
                -8.4654000000000e-09j,
                -1.2698100000000e-08j,
                -1.6930900000000e-08j,
            ],
            [
                0,
                -8.8558806782570e-01j,
...
def test_sampled_wave_open_cardioid():
    array_configuration = io.ArrayConfiguration(
        array_radius=0.01, array_type="open", transducer_type="cardioid"
    )
    results_open_cardioid = np.array(
        [
            [
                1.7724538509055e00,
                1.4967049769369e00 + 4.9979728197650e-01j,
            ...
            [
                7.2360125455830e-01,
                3.8587923539310e-01 + 6.1212416373860e-01j,
            ...
            [
                -2.0990000000000e-10,
                -2.0990000000000e-10 - 2.1160000000000e-10j,
    ...
    results_rigid_omni = np.array(
        [
            [
                ...
                0.8286396985424 - 0.9508074768159j,
                1.7529564648366 + 0.0437757668065j,
            ],
            [
    ...
    results_rigid_cardioid = np.array(
        [
            [
                ...
                -0.6028519679960 + 0.7669321885739j,
                -0.6309703729264 - 0.118525523167j,
                0.5051010853392 - 0.9241602374611j,
